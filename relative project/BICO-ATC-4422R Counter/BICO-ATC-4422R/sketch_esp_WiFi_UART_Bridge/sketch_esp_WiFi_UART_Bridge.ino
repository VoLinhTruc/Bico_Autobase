//To modifying SSID and password, goto line 72
//To modifying IP parameter, goto line 68
//To modifying port, goto line 37
...
IPAddress ip_address(192, 168, 0, 69);
...
void setup() {
  // disconnect wifi beofore connect AP to be sure ESP connect to AP correctly
  WiFi.disconnect();
